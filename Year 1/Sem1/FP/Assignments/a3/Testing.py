...
List_11 = [67, 105, 181, 197, 257, 453, 475, 608, 904, 987]
List_12 = [161]
List_13= [52, 327, 388, 393, 490, 492, 543, 556, 656, 673]
""" Sorted Lists
...
def testing_list():
    ...
    assert Jump_search(List_11, 257, len(List_11) - 1) == 4
    assert Jump_search(List_12,161,len(List_12)-1) == 0
    assert Jump_search(List_13, 1, len(List_13)-1) == -1
    assert Jump_search(List_13, 1000, len(List_13)-1) == -1
testing_list()
