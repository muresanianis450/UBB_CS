        ...
        if len(rand_list) == 0:
            ...
            match choice:
                ...
                case 2:
                    ...
                    try:
                        number = int(number)
                        position = Jump_sort(rand_list, number, len(rand_list)-1)
                        if position == -1:
                ...
                case 3:
                    pas = input("Please enter the frequency you want the process of the sorting algorithm to be shown: ")
                    try:
                        pas = int(pas)
