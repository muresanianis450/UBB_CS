...
void testAllExtended() {
	...
	// Add debugging output in each test
	testCreate();
	std::cout << "Test add and search" << std::endl;
	testAddAndSearch();
	std::cout << "Test other operations" << std::endl;
	// Continue adding debug statements for other tests
}
